...
public enum SheepTrait implements Trait { //traits designed for sheep
  RED("red", GeneType.MENDELIAN,
      "Encodes for sheep phenotypic color, reference the wiki for the different color combinations."),
  BLUE("blue", GeneType.MENDELIAN,
      "Encodes for sheep phenotypic color, reference the wiki for the different color combinations."),
  GREEN("green", GeneType.MENDELIAN,
      "Encodes for sheep phenotypic color, reference the wiki for the different color combinations."),
  WHITE_OVERRIDE("override", GeneType.MENDELIAN,
      "Epistatic "), //dominant phenotypes always exhibit white, allows for masking of colors
  BRIGHTNESS("brightness", GeneType.INTEGER, "Provided 'override' is recessive, if there are no color genes, then the color will be selected on the brightness.");
  ...
  SheepTrait(String key, GeneType geneType, String description) {
    this.key = key;
