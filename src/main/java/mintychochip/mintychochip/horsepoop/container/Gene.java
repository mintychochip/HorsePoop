...
public class Gene {
    ...
    private Gene(Trait trait, HorseConfig horseConfig) {

        Gson gson = HorsePoop.GSON;
        this.trait = gson.toJson(trait);
        Random random = Genesis.RANDOM;
        GenesisConfigurationSection attribute = horseConfig.getAttribute(trait);
        ...
        GenesisConfigurationSection meta = horseConfig.getMeta(trait);
    ...
    private Gene(Trait trait, HorseConfig horseConfig, String value) {
    ...
    public static Gene createInstance(Trait trait, HorseConfig horseConfig, GeneFactory instance) { //do something with factory instance after
        return new Gene(trait, horseConfig);
    }

    public static Gene createInstance(Trait trait, HorseConfig horseConfig, String value, GeneFactory instance) {
        return new Gene(trait,horseConfig,value);
    }
