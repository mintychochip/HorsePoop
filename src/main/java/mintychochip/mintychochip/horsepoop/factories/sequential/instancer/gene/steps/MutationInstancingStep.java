...
public class MutationInstancingStep<T extends Characteristic> implements InstancingStep<T> {
  ...
  private <U extends Trait> boolean traitAlreadyExists(U trait, List<BaseTrait<T>> baseTraits,
      List<BaseTrait<T>> traits) {
