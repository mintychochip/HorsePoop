...
public class TraitGeneratorImpl<T extends Characteristic> implements
    TraitGenerator<T> { //rename this class
  ...
  private String generateValue(Trait trait, Characteristic traitMeta) {
